                            ...
                            <table class="table table-stripped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#verifikasi<?php echo $data['id_pengaduan'] ?>">Verifikasi</a>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="POST">
                                                        ...
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" name="judul" class="form-control" value="<?php echo $data['judul_laporan']?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-2">
                                                        ...
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-md-4">
                                                            <img src="../asset/img/<?php echo $data['foto']?>" width="100px">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-2">
